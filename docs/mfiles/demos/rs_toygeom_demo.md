# rs_toygeom_demo
Demonstrate geometric modeling with toy simulated datasets
...
See also:  [rs_import_coordsets](rs_import_coordsets.md), [rs_disp_coordsets](rs_disp_coordsets.md), [rs_disp_geofit](rs_disp_geofit.md)
