...
from demos.rs_detailed_choice_file_demo import generate_comparisons, process_subject_data, standardize_comparison_keys,\
    replace_stimuli_with_ids
...
class TestParseRawJudgmentFiles(unittest.TestCase):
    def test_process_subject_data_trial_counts(self):
        ...
        comps, stim_set = process_subject_data(str(tmp_path))
    ...
    def test_process_subject_data_stimulus_set(self):
        ...
        _, stim_set = process_subject_data(str(tmp_path))
    ...
    def test_process_subject_data_reference_assignment(self):
        ...
        comps, _ = process_subject_data(str(tmp_path))
