...
%
%  See also:  RS_XFORM_SPECIFY, RS_XFORM_SPECIFY_APPLY_TEST, RS_BENCHMARK_COMPARE, RS_SAVE_MAT.
%
...
aux_ins{1}.opts_read=setfields(auxs_force.opts_read,{'input_type','if_auto','if_log'},{[1 2 1],1,1});
aux_ins{1}.nsets=3;
signflips{1}={{'data_read','ds'}};
%
