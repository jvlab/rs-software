...
auxs_force=struct;
opts_needed={'opts_read','opts_rays','opts_qpred','opts_check'};
...
auxs{2}=auxs_force;
auxs{2}.opts_read=setfields(auxs_force.opts_read,{'input_type','if_auto','if_log'},{[1 2],1,1});
auxs{2}.nsets=3;
...
auxs{3}=auxs_force;
auxs{3}.opts_read=setfields(auxs_force.opts_read,{'input_type','if_auto','if_log'},{1,1,1});
auxs{3}.nsets=2;
%
...
auxs{4}=auxs_force;
auxs{4}.opts_read=setfields(auxs_force.opts_read,{'input_type','if_auto','if_log'},{1,1,1});
auxs{4}.nsets=4;
%
