%rs_read_coorddata_demo_opposites: read coordinate data and create a dataset structure in a domain with stimulus coordinates
%
...
if ~exist('which_read') which_read=getinp('choice','d',[1 4],1); end %#demo-input: 1
if ~exist('if_builtin') if_builtin=getinp('1 for built-in file names, 0 to specify via gui','d',[0 1],1); end  %#demo-input: 1
%
