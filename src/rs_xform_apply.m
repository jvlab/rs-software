...
%
%         - class (char): 'affine','mean','procrustes','projective','pwaffine','pwprojective'; default is 'affine'; see `transformation structures` and note below regarding transformations
