...
def rms_dist_curvature(path_to_data_dir, condition, num_dists=666):
    ...
    # !calculate distances based on scripts param value!
    path_to_npy_files = '{}/{}_data/scripts/*/*/*sigma_1.0*dim_{}*.npy'
    rms_sigma = {}
    for dimension in DIMENSIONS:
        npy_files = glob.glob(path_to_npy_files.format(path_to_data_dir, condition, dimension))
        for npy_file in npy_files:
            # get filename and use metdata to populate subject, domain, scripts vals
...
if __name__ == '__main__':
    ...
    files = glob.glob('{}/{}_data/scripts/*/*/*.csv'.format(DATA_DIR, CONDITION))
