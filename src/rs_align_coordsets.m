...
%         - if_type_coords_remake (int):  controls alignment of stimulus coordinates, typically omitted or set to [], see note below regarding stimulus coordinates
...
%     - opts_align (struct): aux.opts_align, with defaults filled in, and also
%
