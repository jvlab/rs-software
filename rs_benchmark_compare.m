...
% opts: options
%  opts.signflips{k}: a cell array of nested fieldnames pointing to variables that may have a dimension sign-flipped, defaults to empthy
...
%
%   See also:  FILLDEFAULT, RMSUBFIELD, GETSUBFIELD, COMPARE_SIGNFLIP.
%
if (nargin<=1)
    opts=struct;
end
